...
from detectron2.evaluation import DatasetEvaluator, DatasetEvaluators, inference_context,COCOEvaluator
...
def register_esmart_wip(root = "/home/vaibhav/Desktop/stud/datasets/esmart/"):
        ...
        register_coco_instances(
                        name,
                        metadata,
                        os.path.join(root, 'labels_mod_bbox.json'),
...
evaluator = COCOEvaluator("esmart_wip", tasks=("bbox"),  distributed=False, output_dir="./output/coco_on_esmart")
val_loader = build_detection_test_loader(cfg, "esmart_wip")
custom_inference_on_dataset(predictor.model, val_loader, evaluator)
